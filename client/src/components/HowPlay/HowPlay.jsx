  ...
  return (
    <div className="gameInstructions">
      <Box
        ...
        <h3>Challenge:</h3>
        <p>
          After reviewing the code block and tapping on “Go” you have 60 seconds to fill in as many
          of the fading syntax spaces as possible. The answers will fade within 5 seconds since the
          start of the game. The faster you fill out the code block the better your score!
        </p>
        <h3>Points:</h3>
